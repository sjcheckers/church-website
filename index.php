...
<head>
  ...
  <title><B>Christ Is Love Deliverance Church</B></title>
...
<head>
  ...
  <title><B>Christ Is Love Deliverance Church - CLDC Uganda</B></title>
...
</html>s="nav-item"><a class="nav-link" href="#gallery">Gallery</a></li>
        <li class="nav-item"><a class="nav-link" href="#contact">Contact</a></li>
      </ul>
    </div>
  </div>
...
<div class="container page-wrap">
  ...
  <section id="contact" class="section">
    ...
    <div class="d-flex gap-3 mt-2 contact-icons">
      ...
      <a href="https://chat.whatsapp.com/KwVxpXd1RUC2KAAVFmCepI?mode=ac_t" target="_blank"><img src="whatsapp.png" alt="WhatsApp"></a>
    </div>
